				...
				<?= $this->Form->create($category, ['id' => 'main-form', 'class'=>'form-horizontal']) ?>
					...
					<div class="card-body" style="opacity: 0;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<?= $this->Form->control('keywords', ['placeholder' => __(''), 'type'=>'text', 'class'=>'form-control', 'label' => false, 'autofocus' => false, "required" => false]) ?>
							</div>
						</div>

						<!-- 6. string -->
						<div class="form-group row">
							<label for="iconType" class="col-sm-2 col-form-label text-right"><a href="https://oblador.github.io/react-native-vector-icons/" target="_new"><?= __('IconType') ?> (click here)</a>:</label>
							<div class="col-sm-3">
								<?= $this->Form->control('iconType', ['options' => $iconTypes, 'value' => 'MaterialCommunityIcons', 'placeholder' => __(''), 'class'=>'form-control', 'label' => false, 'empty' => true, 'autofocus' => false, "required" => true]) ?>
							</div>
							<div class="col-sm-3">
								<?= $this->Form->control('icon', ['placeholder' => __(''), 'type'=>'text', 'class'=>'form-control', 'label' => false, 'empty' => true, 'autofocus' => false, "required" => true]) ?>
							</div>
						</div>
