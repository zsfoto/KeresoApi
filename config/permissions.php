...
return [
    'CakeDC/Auth.permissions' => [
		...
		// A Kereső's permissions
        /*
        [
            'role' => ['user'],
            'plugin' => 'CakeDC/Users',
            'controller' => ['Users'],            
            'action' => ['resetPassword', 'changePassword'],
            'allowed' => true
        ],
        */
        ...
        // http://kereso.loc/persons/ajaxSaveCategory
        // http://kereso.loc/persons/ajaxSaveCategory/1.json
        [
            'role' => '*',    // 'new', 'user', 
            'controller' => 'Persons',
            'action' => ['ajaxSaveCategory', 'ajaxSaveCity'],   // 'ajaxSaveDetails', 'ajaxSaveMorePhones'
            //'extension' => 'json',
            'bypassAuth' => true,
        ],
