			...
			'admin' => [ // ------------------- Prefix ----------------------
				...
				'sidebarMenu' => [
					...
					[
						...
						'type' 	=> 'menuitem',
						'title' => __('Persons'),
						'controller' => 'Persons',			// Controller/Action vagy link!!!! A link az első amit figyelembe vesz!
						'action' => 'index',
						'icon'	=> 'nav-icon fas fa-th',
					],
					[
						...
						'type' 	=> 'menuitem',
						'title' => __('Phones'),
						'controller' => 'Phones',			// Controller/Action vagy link!!!! A link az első amit figyelembe vesz!
						'action' => 'index',
						'icon'	=> 'nav-icon fas fa-th',
					],
					[
						...
						'type' 	=> 'menuitem',
						'title' => __('Openings'),
						'controller' => 'Openings',			// Controller/Action vagy link!!!! A link az első amit figyelembe vesz!
						'action' => 'index',
						'icon'	=> 'nav-icon fas fa-th',
					],
					[
