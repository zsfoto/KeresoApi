...
class CategoriesController extends AppController
{
	...
	public $iconTypes = [
		'AntDesign' => 'Ikon család: AntDesign', 
		'Entypo' => 'Entypo', 
		'EvilIcons' => 'EvilIcons', 
		'Feather' => 'Feather', 
    ...
    public function add()
    {
        ...
        //$myUsers = $this->Categories->MyUsers->find('list', ['limit' => 200]);	// Original
		//$myUsers = $this->Categories->MyUsers->find('list', ['limit' => 200, 'conditions'=>['MyUsers.visible' => 1], 'order'=>['MyUsers.pos' => 'asc', 'MyUsers.name' => 'asc']]);
		//$myUsers = $this->Categories->MyUsers->find('list', ['limit' => 200, 'order'=>['MyUsers.pos' => 'asc', 'MyUsers.name' => 'asc']]);
        $this->set('iconTypes', $this->iconTypes);
    ...
    public function edit($id = null)
    {
        ...
        //$myUsers = $this->Categories->MyUsers->find('list', ['limit' => 200]);
		//$myUsers = $this->Categories->MyUsers->find('list', ['limit' => 200, 'conditions'=>['MyUsers.visible' => 1], 'order'=>['MyUsers.pos' => 'asc', 'MyUsers.name' => 'asc']]);
		//$myUsers = $this->Categories->MyUsers->find('list', ['limit' => 200, 'order'=>['MyUsers.pos' => 'asc', 'MyUsers.name' => 'asc']]);
